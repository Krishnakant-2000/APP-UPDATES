...
class SettingsErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    console.group('🚨 SettingsErrorBoundary - Error Caught');
    ...
    if ((window as any).performanceErrorBoundary) {
      try {
        (window as any).performanceErrorBoundary.safeExecute(() => {
          console.log('🔧 Settings Error logged to performance boundary');
  ...
  handleRetry = () => {
    console.log('🔄 SettingsErrorBoundary - Retry attempt', this.state.retryCount + 1);
    ...
    if (this.state.retryCount < this.maxRetries) {
      ...
      console.log('🔄 SettingsErrorBoundary - Max retries reached, suggesting page refresh');
