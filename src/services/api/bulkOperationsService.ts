...
class BulkOperationsService {
  ...
  async executeBulkOperation(
    ...
    console.log(`Starting bulk operation: ${operation} on ${items.length} items`);
    ...
    try {
      ...
      console.log(`Bulk operation completed: ${result.processedCount} processed, ${result.failedCount} failed`);
  ...
  private async logBulkOperation(
    ...
    try {
      ...
      console.log('Bulk operation logged:', operationId);
    } catch (error) {
